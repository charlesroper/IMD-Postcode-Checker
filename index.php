...
function getDecileInt()
{
    ...
    $decile = filter_input(INPUT_GET, 'd', FILTER_VALIDATE_INT, $options);

    // If validation fails (returns false), use the default value.
    return ($decile === false) ? $options['options']['default'] : (int)$decile;
}
