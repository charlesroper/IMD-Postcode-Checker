...
$current_year_dt = new DateTime('now', new DateTimeZone('Europe/London'));
$current_year = $current_year_dt->format('Y');
...
<head>
  ...
  <meta property="og:title" content="English IMD 2025 Postcode Checker">
  <meta property="og:description" content="This simple tool enables you to look up the Index of Multiple Deprivation (IMD) rank for a list of postcodes.">
  <meta property="og:url" content="<?php echo htmlspecialchars($base_url, ENT_QUOTES, 'UTF-8'); ?>">
  <meta property="og:image" content="https://pic.fish/<?php echo htmlspecialchars($base_url, ENT_QUOTES, 'UTF-8'); ?>">
  <meta property="og:type" content="website">

  <!-- Twitter Card Meta Tags -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="English IMD 2025 Postcode Checker">
  <meta name="twitter:description" content="This simple tool enables you to look up the Index of Multiple Deprivation (IMD) rank for a list of postcodes.">
  <meta name="twitter:image" content="https://pic.fish/<?php echo htmlspecialchars($base_url, ENT_QUOTES, 'UTF-8'); ?>">
...
<body>
  ...
  <footer>
    <div class="footer-content">
      ...
      <p>Originally made for the <a href="https://www.field-studies-council.org/">Field Studies Council</a>. Copyright &copy; <?php echo $current_year; ?> Charles Roper. <a href="https://charlesroper.com/">Get in touch</a>.</p>
      <p>
