...
Two coverage report formats are available:

- **HTML Report** - Visual coverage report at `coverage/index.html` (generated by `composer test-coverage`)
- **JSON Report** - Machine-readable summary at `coverage/coverage-summary.json` (see `scripts/README.md`)
